...
public class GameProgress implements Serializable {
    ...
    public void openZip(String zipFile, String zipDirectory) {

        try (FileInputStream fin = new FileInputStream(zipFile); //
             ZipInputStream zis = new ZipInputStream(fin)) {
            ZipEntry entry; //класс объекта архива
            String name;
            while ((entry = zis.getNextEntry()) != null) {
                name = entry.getName();
                FileOutputStream fout = new FileOutputStream(new File(zipDirectory, name));
    ...
    public GameProgress openProgress(String gameFileDirectory) {
        GameProgress gameProgress = null;
        try (FileInputStream fis = new FileInputStream(gameFileDirectory);
